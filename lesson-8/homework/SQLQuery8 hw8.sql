...
GROUP BY ProductID;
--10. solution
SELECT SupplierID, AVG(UnitPrice) AS AvgSupplierPrice
FROM Products
GROUP BY SupplierID;
--11. solution
...
FROM OrderDetails;
--17. solution
SELECT ShipperID, COUNT(*) AS ShipmentCount
FROM Orders
GROUP BY ShipperID;
--18. solution
...
HAVING COUNT(*) > 7;
--20. solution
SELECT o.CustomerID, COUNT(*) AS OrdersCount
FROM Orders o
...
HAVING COUNT(*) > 5;
--21. solution
SELECT ProductID, COUNT(*) AS OrderLines
FROM OrderDetails
GROUP BY ProductID
HAVING COUNT(*) > 30;
--22. solution
